...
{
    public partial class Provision_For_Gratuity : System.Web.UI.Page
    {
        Dal dal = new Dal();
        ...
        public void ExporttoPdf()
        {
            using (StringWriter sw = new StringWriter())
            {
                using (HtmlTextWriter hw = new HtmlTextWriter(sw))
                {
                    ...
                    Response.AddHeader("content-disposition", "attachment;filename=ProvisionForGratuity.pdf");
        ...
        public void ExporttoExcel()
        {
            if (grdReport.Rows.Count > 0)
            {
                ...
                string filname = "ProvisionForGratuity" + DateTime.Now.ToString("ddMMyyyy");
