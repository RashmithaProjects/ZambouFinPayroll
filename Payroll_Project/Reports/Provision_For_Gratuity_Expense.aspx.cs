...
{
    public partial class Provision_For_Gratuity_Expense : System.Web.UI.Page
    {
        Dal dal = new Dal();
        ...
        {
            dt = dal.Provision_For_Gratuity_Expense();
            if (dt.Rows.Count > 0)
            {
        ...
        public void ExporttoPdf()
        {
            using (StringWriter sw = new StringWriter())
            {
                using (HtmlTextWriter hw = new HtmlTextWriter(sw))
                {
                    ...
                    Response.AddHeader("content-disposition", "attachment;filename=ProvisionForGratuityExpense.pdf");
        ...
        public void ExporttoExcel()
        {
            if (grdReport.Rows.Count > 0)
            {
                ...
                string filname = "ProvisionForGratuityExpense" + DateTime.Now.ToString("ddMMyyyy");
