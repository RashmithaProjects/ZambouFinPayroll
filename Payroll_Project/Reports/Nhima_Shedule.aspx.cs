...
{
    public partial class Nhima_Shedule : System.Web.UI.Page
    {
        Dal dal = new Dal();
        ...
        public void ExporttoPdf()
        {
            using (StringWriter sw = new StringWriter())
            {
                using (HtmlTextWriter hw = new HtmlTextWriter(sw))
                {
                    ...
                    Response.AddHeader("content-disposition", "attachment;filename=NhimaSchedule.pdf");
        ...
        public void ExporttoExcel()
        {
            if (grdReport.Rows.Count > 0)
            {
                ...
                string filname = "NhimaShedule" + DateTime.Now.ToString("ddMMyyyy");
