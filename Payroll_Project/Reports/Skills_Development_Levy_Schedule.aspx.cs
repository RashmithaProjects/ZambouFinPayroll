...
{
    public partial class Skills_Development_Levy_Schedule : System.Web.UI.Page
    {
        Dal dal = new Dal();
        ...
        {
            dt = dal.Skill_Development_Schedule();
            if (dt.Rows.Count > 0)
            {
        ...
        public void ExporttoPdf()
        {
            using (StringWriter sw = new StringWriter())
            {
                using (HtmlTextWriter hw = new HtmlTextWriter(sw))
                {
                    ...
                    Response.AddHeader("content-disposition", "attachment;filename=Skill_Development_Schedule.pdf");
        ...
        public void ExporttoExcel()
        {
            if (grdReport.Rows.Count > 0)
            {
                ...
                string filname = "Skill_Development_Schedule" + DateTime.Now.ToString("ddMMyyyy");
