<%@ Page Title="" Language="C#" MasterPageFile="~/Master3.Master" AutoEventWireup="true" CodeBehind="Provision_For_Gratuity_Expense.aspx.cs" Inherits="Payroll_Project.Reports.Provision_For_Gratuity_Expense" %>
...
<head id="Head1" runat="server">
  ...
  <script src="https://cdn.jsdelivr.net/npm/bootstrap@4.6.2/dist/js/bootstrap.bundle.min.js"></script>
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <asp:Label ID="lblHeading" runat="server" Text="PROVISION FOR GRATUITY EXPENSE - " Font-Bold="true" ></asp:Label>
