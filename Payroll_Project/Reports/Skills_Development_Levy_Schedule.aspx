<%@ Page Title="" Language="C#" MasterPageFile="~/Master3.Master" AutoEventWireup="true" CodeBehind="Skills_Development_Levy_Schedule.aspx.cs" Inherits="Payroll_Project.Reports.Skills_Development_Levy_Schedule" %>
...
<head id="Head1" runat="server">
  ...
  <script src="https://cdn.jsdelivr.net/npm/bootstrap@4.6.2/dist/js/bootstrap.bundle.min.js"></script>
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <asp:Label ID="lblHeading" runat="server" Text="SKILLS DEVELOPMENT LEVY SCHEDULE - " Font-Bold="true" ></asp:Label>
