<%@ Page Title="" Language="C#" MasterPageFile="~/Master3.Master" AutoEventWireup="true" CodeBehind="Nhima_Shedule.aspx.cs" Inherits="Payroll_Project.Reports.Nhima_Shedule" %>
  ...
  <script src="https://cdn.jsdelivr.net/npm/bootstrap@4.6.2/dist/js/bootstrap.bundle.min.js"></script>
    ...
    <%--    <table>
     ...
     <div class="row">
        ...
        <div class="col-md-6">
            <asp:Label ID="lblHeading" runat="server" Text="NHIMA SCHEDULE - " Font-Bold="true" ></asp:Label>
