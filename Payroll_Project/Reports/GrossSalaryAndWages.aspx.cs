...
{
    public partial class GrossSalaryAndWages : System.Web.UI.Page
    {
        Dal dal = new Dal();
        ...
        public void ExporttoPdf()
        {
            using (StringWriter sw = new StringWriter())
            {
                using (HtmlTextWriter hw = new HtmlTextWriter(sw))
                {
                    ...
                    Response.AddHeader("content-disposition", "attachment;filename=GrossSalaryAndWages.pdf");
        ...
        public void ExporttoExcel()
        {
            if (grdReport.Rows.Count > 0)
            {
                ...
                string filname = "GrossSalaryAndWages" + DateTime.Now.ToString("ddMMyyyy");
