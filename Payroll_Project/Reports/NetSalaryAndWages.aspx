<%@ Page Title="" Language="C#" MasterPageFile="~/Master3.Master" AutoEventWireup="true" CodeBehind="NetSalaryAndWages.aspx.cs" Inherits="Payroll_Project.Reports.NetSalaryAndWages" %>
...
<head id="Head1" runat="server">
  ...
  <script src="https://cdn.jsdelivr.net/npm/bootstrap@4.6.2/dist/js/bootstrap.bundle.min.js"></script>
    ...
    <%--    <table>
        <tr>
            <th colspan="2" style="text-align: center; display: inline-block;">ZAMBOU FINANCIAL SERVICES </th>
        </tr>
        <tr>
            <th style="font-family: Calibri; font-size: medium">NET SALARIES & WAGES - SCHEDULE AS AT DECEMBER 31,2022</th>
        </tr>
     ...
     <div class="row">
        ...
        <div class="col-md-6">
            <asp:Label ID="lblHeading" runat="server" Text="NET SALARIES & WAGES - " Font-Bold="true" ></asp:Label>
