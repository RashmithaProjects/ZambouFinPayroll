<%@ Page Title="" Language="C#" MasterPageFile="~/Master3.Master" AutoEventWireup="true" CodeBehind="NAPSA_Expense.aspx.cs" Inherits="Payroll_Project.Reports.NAPSA_Expense" %>
  ...
  <script src="https://cdn.jsdelivr.net/npm/bootstrap@4.6.2/dist/js/bootstrap.bundle.min.js"></script>
    ...
    <%--    <table>
     ...
     <div class="row">
        ...
        <div class="col-md-6">
            <asp:Label ID="lblHeading" runat="server" Text="NAPSA EXPENSE - " Font-Bold="true" ></asp:Label>
